...
const Navbar = () => {
  ...
  return (
    <nav className="fixed w-full top-0 z-50 bg-white/60 backdrop-blur-md border-b border-white/50 shadow-sm py-1 transition-all duration-300 supports-[backdrop-filter]:bg-white/60">
