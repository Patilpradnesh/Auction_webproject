...
const AuctionCarousel = () => {
  ...
  const auctionItems = [
    {
      id: 1,
      image: "https://via.placeholder.com/800x400?text=Luxury+Car+Auction",
      title: "Luxury Car Auction",
      description: "Bid on high-end luxury cars!",
    },
    {
      id: 2,
      image: "https://via.placeholder.com/800x400?text=Rare+Antique+Collection",
      title: "Rare Antique Collection",
      description: "Exclusive antique items up for auction.",
    },
    {
      id: 3,
      image: "https://via.placeholder.com/800x400?text=Real+Estate+Deals",
